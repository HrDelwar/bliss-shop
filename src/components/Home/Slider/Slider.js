...
const content = [
    {
        image:
            "https://www.graceandvision.com.au/wp-content/uploads/2017/10/Silhouette-Urban-Lite-Woman-Mod-1573-6100.jpg",
        title1: `AVIATOR`,
        title2: `VERRES`,
    ...
    {
        image:
            "https://www.graceandvision.com.au/wp-content/uploads/2017/10/Silhouette-Dynamic-Colourwave-Fullrim-Woman-mod-5508-7000.jpg",
        title1: `AVIATOR`,
        title2: `VERRES`,
        title3: `ICEBERGGLASSES`,
        details: "Looked up one of the more obscure latin words",
            ...
            <Sliderr classNames={horizontalCss}>
                {content.map((item, index) => (
                    <div
                        ...
                        key={index}
                        style={{
                            background: `url('${item.image}' ) no-repeat top center`,
                            opacity: "0.9",
                            // height: "auto",
                            // width: "100%",
